...
export default function GameIntro({gameState,setGameState}) {
    const containerVariants = {
        hidden: { opacity: 0, scale: 0, y: -600 }, // start from above the screen
        visible: { opacity: 1, scale: 1, y: 0, transition: { duration: 2 } }, // move to the center of the screen
        exit: { opacity: 0, scale: 0, y: 600, transition: { duration: 2 } }, // move to below the screen
      };
